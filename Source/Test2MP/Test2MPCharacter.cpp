...
ATest2MPCharacter::ATest2MPCharacter()
{
...
void ATest2MPCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ATest2MPCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ATest2MPCharacter::Look);
	}
	else
	{
